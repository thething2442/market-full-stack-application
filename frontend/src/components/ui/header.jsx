...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/60">
        ...
        <div className="flex items-center space-x-4">
          <dropdown.DropdownMenu>
            ...
            <dropdown.DropdownMenuContent>
              <div className="p-4 text-xl font-bold">Your Name</div>
              ...
              <dropdown.DropdownMenuSeparator />
              {/* This item now triggers the state change */}
              <dropdown.DropdownMenuItem
      ...
      {/* 3. Render the alert dialog outside the dropdown menu */}
      <alert_dialog.AlertDialog open={isAlertDialogOpen} onOpenChange={setIsAlertDialogOpen}>
        <alert_dialog.AlertDialogContent>
          ...
          <alert_dialog.AlertDialogFooter>
            ...
            <alert_dialog.AlertDialogAction>Log Out</alert_dialog.AlertDialogAction>
          </alert_dialog.AlertDialogFooter>
        </alert_dialog.AlertDialogContent>
